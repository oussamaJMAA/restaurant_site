...
$a1=null;
$error=""; 
if(isset($_GET['idf']) && isset($_GET['idc']) && isset($_GET['totalpoints']) && isset($_GET['mail'])&& isset($_GET['password'])) 
{   
        $idf=$_GET['idf'];
        $idc=$_GET['idc'];
...
$a1=new carte($idf,$idc,$totalpoints,$mail,$password);
$carteC=new carteC();
...
<h2 class="text-uppercase">cARTE FIDELITE</h2>
...
<input type="email" name="mail" id=mail" pattern=".+@gmail.com|.+@esprit.tn" class="form-control">
...
<button type="submit" name="supprimer" value="supprimer" class="btn btn-default pull-right">Delete</button>
