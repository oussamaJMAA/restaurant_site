...
<input type="email" name="mail" id=mail" pattern=".+@gmail.com|.+@esprit.tn|.+@yahoo.fr" class="form-control">
...
<button type="submit" value="Envoyer" class="btn btn-default pull-right">Register</button>
