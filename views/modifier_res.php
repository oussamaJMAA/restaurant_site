...
<label for="datepicker">Date</label>
 <input type="date" name="dater" class="form-control" placeholder="Pick a date" title="Please choose a date" required>
...
<input type="email" class="form-control" id="email" name="email" placeholder="Your Email ID" title="Please enter your email id">
