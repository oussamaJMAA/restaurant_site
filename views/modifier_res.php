...
$a1=null;
$error="";
if (isset($_POST['name']) && isset($_POST['guests'])&& isset($_POST['dater'])&& isset($_POST['time'])) {
...
$a1=new res($nom,$email,$tel,$date,$time,$guests);
$resC=new resC();
$suc=1;
}
...
$db = config::getConnexion();
$stmt = $db->prepare("SELECT * FROM reservation WHERE email=:user_id");
 $stmt->execute(array(":user_id"=>$user_id));
 $reserRow=$stmt->fetch(PDO::FETCH_ASSOC);
...
<!---from here starts the form section *****************************************************************-->



<form action="" id="reservationform" method="POST" name ="form" >
<div class="row">
<div class="col-md-4 col-sm-6">
<div class="form-group">
<label for="datepicker">Date</label>
 <input type="date" name="dater" class="form-control" placeholder="Pick a date" value="<?php print($userRow['date']) ?>" title="Please choose a date" required>
...
<input type="text" class="form-control" id="name" name="name" value="<?php print($userRow['login']) ?>" placeholder="Full Name" title="Your Full Name please"disabled>
...
<input type="text" class="form-control" id="timepicker" name="time" value="<?php print($reserRow['time']) ?>" placeholder="Pick a time" title="Choose Preferred Time" required>
...
<input class="form-control" type="number" id="guests" name="guests" value="<?php print($reserRow['guests']) ?>" placeholder="How many of you?" title="Please enter number of guests" required>
...
<input type="text" class="form-control" id="phone" name="phone" placeholder="Enter your Phone Number" value="<?php print($reserRow['phone']) ?>" title="Please enter your phone number" required>
...
<input type="email" class="form-control" id="email" name="email" value="<?php print($userRow['email']) ?>"placeholder="Your Email ID" title="Please enter your email id" disabled>
<i class="fa fa-envelope-o"></i>
</div>
</div>
<div class="col-md-12 col-sm-12">
<div class="reservation-btn">
<button type="submit" class="btn btn-default btn-lg" id="js-reservation-btn">Update Reservation</button>
...
<a href="ajouter_res.php"> <-- Return </a>
<br>
<a href="supprimer_res.php"> Delete a Reservation </a>
<div class="reservation-footer">
<p>You can also call: <strong>+216 77 77 77 77</strong> to make a reservation.</p>
<span></span>
</div>
</div>
</section>
