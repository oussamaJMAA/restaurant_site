...
<div class="col-md-6">
<form method="POST" action="modifierReclamationC.php" >
<input type="hidden" value="<?PHP 
    echo $_POST['id']; ?>" name="id">
<div class="form-group">
<input value="<?php echo $_POST["nom"];?>" class="form-control" name="nom" id="nom" placeholder="Full Name" type="text"  disabled />
</div>
<div class="form-group">
<input value="<?php echo $_POST["email"];?>" class="form-control" type="email" name="email" id="email" placeholder="Email Address" disabled />
</div>
<div class="form-group">
<input value="<?php echo $_POST["sujet"];?>" class="form-control" placeholder="Subject" type="text" id="sujet" name="sujet" required="required">
</div>
<div class="form-group">
...
<div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" href="modifierReclamationC.php">Send Message</button></div>
