...
include "../controller/UtilisateurC.php";
    ...
    $select_stmt=$db->prepare("SELECT * FROM menu"); //sql select query
    $select_stmt->execute();
...
<img src="img/shop/<?php echo $row['image_plat'] ?>" alt="" />
</div>
...
<a href="shop_cart.html" class="pull-right"><i class="fa fa-heart-o"></i> Wishlist</a>
</div>
</div>
</div>
<div class="col-md-4 col-sm-6">
...
<h4><a href="recipe_detail-image.html"><?php echo $row['nom_plat'] ?></a></h4>
<div class="rc-ratings">
<span class="fa fa-star active"></span>
<span class="fa fa-star active"></span>
<span class="fa fa-star active"></span>
...
<div class="product-info">
<div class="product-img">
<img src="img/<?php echo $row['image_plat'] ?>" alt="" />
</div>
<h4><a href="recipe_detail-image.html">Food Name</a></h4>
<div class="rc-ratings">
<span class="fa fa-star active"></span>
...
<a href="index-2.html" class="btn btn-default load-more">Load more</a>
</div>
</div>
</div>
</section>
...
<p><i class="fa fa-envelope-o"></i><a href="https://demo.web3canvas.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d6a5a3a6a6b9a4a296a4b3a5a2b7a3a4b7b8a2f8b5b9bb">[email&#160;protected]</a></p>
</div>
</div>
</div>
</div>
...
<!-- Mirrored from demo.web3canvas.com/themeforest/tomato/shop_fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Apr 2021 00:16:00 GMT -->
</html>
