...
<p>Checkout or add some items to your Wishlist</p>
</div>
</div>
</div>
</section>
...
$wish=new resC();
$liste=$wish->affiche2($userRow['id']);
foreach($liste as $wish){

?>
<tr>
<td>
<form method="POST" action="delete_wish_list.php">
						<input type="submit" name="supprimer" value="supprimer">
						<input type="hidden" value=<?PHP echo $wish['idplat']; ?> name="ida">
						</form>
</td>
