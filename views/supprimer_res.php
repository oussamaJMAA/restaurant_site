...
$a1=null;
$error="";
if (isset($_POST['name2']) && isset($_POST['guests'])&& isset($_POST['dater'])&& isset($_POST['time'])) {
...
<input type="text" class="form-control" id="name" name="name2" value="<?php print($userRow['login']) ?>" placeholder="Full Name" title="Your Full Name please" required>
...
<div class="form-group">
 ...
 <input type="date" name="dater" class="form-control" placeholder="Pick a date" title="Please choose a date" style="display:none">
...
<input type="text" class="form-control" id="phone" name="phone" value="<?php print($reserRow['phone']) ?>" placeholder="Enter your Phone Number" title="Please enter your phone number" required>
...
<input type="text" class="form-control" id="timepicker" name="time" placeholder="Pick a time" title="Choose Preferred Time" style="display:none">
...
<input type="email" class="form-control" id="email" name="email" placeholder="Your Email ID" title="Please enter your email id" style="display:none">
...
<input class="form-control" type="number" id="guests" name="guests" placeholder="How many of you?" title="Please enter number of guests" style="display:none">
...
<button type="submit" class="btn btn-default btn-lg" id="js-reservation-btn">Delete a Reservation</button>
...
<br>
<a href="modifier_res.php"> Update a Reservation </a>
