...
$mail->addReplyTo('roukaia70@gmail.com', 'roukaia khelifi');
...
<p style="display:none" name="message">Bonjour, YummyFooders! Votre Reservation est confirmé Merci D'etre la f wa9t</p>
<p style="display:none" name="subject">Reservation</p>
...
<label for="datepicker">Date</label>
 <input type="date" name="dater" class="form-control" placeholder="Pick a date" title="Please choose a date" min="2021-04-21">
