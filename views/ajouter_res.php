...
$a1=null;
$error="";
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['guests']) && isset($_POST['phone2'])&& isset($_POST['dater'])&& isset($_POST['time'])) {
...
$a1=new res($nom,$email,$tel,$date,$time,$guests,$idclient);
$resC=new resC();
$suc=1;
}
...
<![endif]-->
	...
	<?php
	if($suc==1)
	$resC->ajouter($a1,$_POST['idclient']);
...
<form action="" name="form1" method="POST" onsubmit="return verif()" >
<div class="row">
