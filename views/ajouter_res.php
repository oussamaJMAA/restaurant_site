...
$a1=null;
$error="";
if (isset($_GET['name']) && isset($_GET['email']) && isset($_GET['guests']) && isset($_GET['phone2'])&& isset($_GET['dater'])&& isset($_GET['time'])) {
...
if (!(isNaN(phone)) || phone.value.match(t) ){
    ...
    document.getElementById('errorname').innerHTML=""; 
     ...
     if(date.value === ""){
    document.getElementById('errorname').innerHTML="Vous Devez Choisir Un date";
return false;

}else{
    var today= new Date();
    date.value=new Date(date.value);
    var dayChosen=date.value.getDate();
    var daytoday=today.getDate();
    if(dayChosen < daytoday){
        document.getElementById('errorname').innerHTML="Votre Date est invalide";
        return false;
        event.preventDefault();
    }else{
        document.getElementById('errorname').innerHTML="Votre date est Valide !"
    }
}
...
<form action="" name="form1" method="GET" onsubmit="return verif()" >
<div class="row">
<div class="col-md-4 col-sm-6">
<div class="form-group">
<label for="datepicker">Date</label>
 <input type="date" name="dater" class="form-control" id ="dater" placeholder="Pick a date" title="Please choose a date" min="2021-04-21">
...
<input type="text" class="form-control name" id="name2" name="name" placeholder="Full Name" title="Your Full Name please" > 
...
<input type="text" class="form-control" id="timepicker" name="time" placeholder="Pick a time" title="Choose Preferred Time" >
...
<input type="text" class="form-control" id="email" name="email" placeholder="Your Email ID" title="Please enter your email id" >
...
<input class="form-control" type="number" id="guests" name="guests" placeholder="How many of you?" title="Please enter number of guests">
...
<input type="text" class="form-control" id="phone" name="phone2" placeholder="Enter your Phone Number" title="Please enter your phone number" >
<i class="fa fa-phone"></i>
</div>
</div>
<div class="col-md-12 col-sm-12">
<div class="reservation-btn">
<input type="submit" class="btn btn-default btn-lg" id="js-reservation-btn"  value="Make Reservation">
...
<form class="form-inline" id="invite" method="GET">
<div class="form-group">
